...
<body>
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						...
						<li class="nav-item">
							<a class="nav-link active" href="#">Venta de productos</a>
						</li>
					</ul>
				</div>
			</div>
        ...
        <div class="container mb-5">
             <div class="row mt-5 d-flex justify-content-center">
                <div class="col-12 col-md-5">
                    <h3 class="fuente2 fw-bold text-center">Venta de productos</h3>
                    <form action="<?= site_url('/venta/productos/nuevo') ?>" method="POST" class="mt-4">
                        <div class="mb-3">
    ...
    <footer class="fondoDos p-5 fixed-bottom">
		<div class="container-fluid">
			<div class="row">
